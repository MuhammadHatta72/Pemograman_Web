        ...
        <div class="w-full h-screen bg-gray-50 rounded-l-xl overflow-y-scroll dark:bg-slate-700" id="contentBar">
            ...
            <div class="container p-5">
                ...
                <div class="flex flex-col sm:flex-row">
                    <div class="w-full sm:w-80 max-w-sm p-6 bg-white border-b-4 border-solid border-amber-500 rounded-lg shadow-md mb-3 sm:mr-4 sm:mb-0 dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex">
                            <img src="../assets/img/item1.png" alt="user" class="w-10 h-10 mb-2">
                            <h2 class="text-xl font-semibold tracking-tight text-gray-800 dark:text-white ml-3 pt-2"><?= countBook(); ?> Total Buku</h2>
                        </div>
                        <p class="mb-3 text-sm font-normal text-gray-500 dark:text-gray-400">Jumlah semua buku yang ada.</p>
                        <a href="./booksA.php" class="inline-flex items-center text-sm text-blue-600 hover:underline">
                            Selengkapnya
                    ...
                    <div class="w-full sm:w-80 max-w-sm p-6 bg-white border-b-4 border-solid border-cyan-500 rounded-lg shadow-md mb-3 sm:mr-4 sm:mb-0 dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex">
                            <img src="../assets/img/item2.png" alt="user" class="w-10 h-10 mb-2">
                            <h2 class="text-xl font-semibold tracking-tight text-gray-800 dark:text-white ml-3 pt-2">15 Dipinjam</h2>
                        </div>
                        <p class="mb-3 text-sm font-normal text-gray-500 dark:text-gray-400">Jumlah buku yang telah di pinjam.</p>
                    ...
                    <div class="w-full sm:w-80 max-w-sm p-6 bg-white border-b-4 border-solid border-red-800 rounded-lg shadow-md mb-3 sm:mr-4 sm:mb-0 dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex">
                            <img src="../assets/img/item3.png" alt="user" class="w-10 h-10 mb-2">
                            <h2 class="text-xl font-semibold tracking-tight text-gray-800 dark:text-white ml-3 pt-2">
                                <?php
                                $bookReady = countBookReady();
                                $countBookReady = mysqli_fetch_assoc($bookReady);
                                echo $countBookReady['countBookReady'];
                                ?> Buku
                            </h2>
                        </div>
                        <p class="mb-3 text-sm font-normal text-gray-500 dark:text-gray-400">Jumlah buku yang tersedia.</p>
                        <a href="#" class="inline-flex items-center text-sm text-blue-600 hover:underline">
                            Selengkapnya
                            <svg class="w-5 h-5 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z"></path>
                    ...
                    <div class="w-full sm:w-80 max-w-sm p-6 bg-white border-b-4 border-solid border-sky-600 rounded-lg shadow-md mb-3 sm:mr-0 sm:mb-0 dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex">
                            <img src="../assets/img/item4.png" alt="user" class="w-10 h-10 mb-2">
                            <h2 class="text-xl font-semibold tracking-tight text-gray-800 dark:text-white ml-3 pt-2">3 Laporan</h2>
                        </div>
                        <p class="mb-3 text-sm font-normal text-gray-500 dark:text-gray-400">Laporan buku</p>
                        <a href="#" class="inline-flex items-center text-sm text-blue-600 hover:underline">
                            Selengkapnya
                            <svg class="w-5 h-5 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z"></path>

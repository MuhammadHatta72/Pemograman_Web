...
<head>
    ...
    <title>Laporan Buku - Sistem Informasi Perpustakaan</title>
    ...
    <div class="flex w-full bg-white dark:bg-slate-800">
        ...
        <div class="w-full h-screen bg-gray-50 rounded-l-xl overflow-y-scroll dark:bg-slate-700" id="contentBar">
            ...
            <div class="container mx-auto px-6 pt-4">
                <h3 class="text-gray-700 text-3xl font-medium dark:text-gray-50">Laporan Buku</h3>
            </div>
            <!-- End Titlepage -->
            ...
            <div class="container p-5">
                ...
                <div class="overflow-x-auto static shadow-md p-5 rounded-md">
                    ...
                    <a href="./printReportBook.php" class="block font-semibold mt-3 py-1 px-4 sm:mt-5 sm:py-2 sm:px-6 bg-emerald-600 rounded-full shadow text-slate-100 hover:bg-emerald-800 hover:text-white hover:shadow-md text-center">Download Laporan</a>
                </div>

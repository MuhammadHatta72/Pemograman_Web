...
<head>
    ...
    <title>Peminjaman & Pengembalian Buku - Sistem Informasi Perpustakaan</title>
    ...
    <div class="flex w-full bg-white dark:bg-slate-800">
        ...
        <div class="w-full h-screen bg-gray-50 rounded-l-xl overflow-y-scroll dark:bg-slate-700" id="contentBar">
            ...
            <div class="container mx-auto px-6 pt-4">
                <h3 class="text-gray-700 text-xl sm:text-3xl font-medium dark:text-gray-50">Peminjaman & Pengembalian Buku</h3>
            </div>
            <!-- End Titlepage -->
            ...
            <div class="container p-5">
                ...
                <div class="flex flex-col sm:flex-row sm:mt-4">
                            ...
                            <ul class="my-4 space-y-3 h-64 sm:96 overflow-y-scroll">
                                ...
                                ?>
                                    <li class="flex items-center p-3 text-base font-semibold text-gray-900 rounded-lg border-b-2 border-gray-100 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                        ...
                                        <span class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-orange-200 rounded dark:bg-orange-500 dark:text-slate-100"><?= $row['available']; ?></span>
                                    </li>
                                <?php
                                    $i++;
                                }
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg sm:ml-3 sm:w-1/3 sm:mb-4 shadow-md p-3 dark:bg-gray-800 dark:border-gray-700">
                        <div class="py-3">
                            <h5 class="mb-2 text-md font-bold tracking-wide uppercase text-gray-800 dark:text-white">Peminjaman Buku</h5>
                        </div>

                        <form method="POST" action="../controller/lendBookAction.php">
                            <div class="mb-3">
                                <input type="hidden" name="user" value="<?= $user['id_user']; ?>">
                                <label for="book" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Buku Tersedia</label>
                                <select id="book" name="book" class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" required>
                                    <option selected value="">Pilih Buku</option>
                                    <?php
                                    $allBooksReady = getBookReadyLend();
                                    while ($row = mysqli_fetch_assoc($allBooksReady)) {
                                    ?>
                                        <option value="<?= $row['id_book']; ?>"><?= $row['book_title']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <input type="submit" name="submit" value="Pinjam Buku" class="text-white bg-gradient-to-r from-emerald-500 to-sky-400 hover:bg-gradient-to-r hover:from-sky-500 hover:to-emerald-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full shadow-sm hover:shadow-lg px-5 py-2.5 text-center cursor-pointer">
                        </form>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-md p-4 dark:bg-gray-800 dark:border-gray-700 mb-4 sm:mb-5">
                    <h5 class="mb-2 text-md font-bold tracking-wide uppercase text-gray-800 dark:text-white">Peminjaman Buku</h5>
                    <div class="overflow-x-auto static">
                        <table class="display w-full text-sm text-left text-gray-500 dark:text-gray-800" id="lendBooks">
                            <thead class="text-xs text-white uppercase bg-orange-500 dark:bg-gray-800 dark:text-gray-200">
                                <tr>
                            ...
                            <tbody>
                                <?php
                                $i = 1;
                                $allLend = getAllLendBook($user['id_user']);
                                while ($row = mysqli_fetch_assoc($allLend)) {
                                ?>
                                    <tr class="bg-white border-b dark:bg-gray-600 dark:border-gray-700 hover:bg-orange-50 dark:hover:bg-gray-600">
                                        <td class="py-4 px-6 font-medium text-gray-800 whitespace-nowrap dark:text-white">
                                            <?= $row['book_title']; ?>
                                        </td>
                                        ...
                                        <td class="py-4 px-3 dark:text-slate-100 text-amber-600">
                                            <?= $row['status']; ?>
                                        </td>
                                    </tr>
                                <?php
                ...
                <div class="bg-white border border-gray-200 rounded-lg mb-3 sm:mb-0 shadow-md p-4 dark:bg-gray-800 dark:border-gray-700">
                    <h5 class="mb-2 text-md font-bold tracking-wide uppercase text-gray-800 dark:text-white">Pengembalian Buku</h5>
                    <div class="overflow-x-auto static">
                        <table class="display w-full text-sm text-left text-gray-500 dark:text-gray-800" id="returnBooks">
                            <thead class="text-xs text-white uppercase bg-cyan-500 dark:bg-gray-800 dark:text-gray-200">
                                <tr>
                                    <th scope="col" class="py-3 px-6">
                                        Judul Buku
                                    </th>
                            ...
                            <tbody>
                                <?php
                                $i = 1;
                                $allReturn = getAllReturnBook($user['id_user']);
                                while ($row2 = mysqli_fetch_assoc($allReturn)) {
                                ?>
                                    <tr class="bg-white border-b dark:bg-gray-600 dark:border-gray-700 hover:bg-cyan-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="py-4 px-3 dark:text-slate-100 text-lime-600">
                                            <?= $row2['status']; ?>
                                        </td>
                                        <td class="py-4 px-3 dark:text-slate-100 text-lime-600">
                                            <?= $row2['condition_trans']; ?>
                                        </td>
                                        <td class="py-4 px-3 dark:text-slate-100 text-lime-600">
                                            <?= $row2['fine']; ?>
                                        </td>

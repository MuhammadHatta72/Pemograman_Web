...
<head>
    ...
    <title>Daftar Pengguna - Sistem Informasi Perpustakaan</title>
    ...
    <div class="flex w-full bg-white dark:bg-slate-800">
        ...
        <div class="w-full h-screen bg-gray-50 rounded-l-xl overflow-y-scroll dark:bg-slate-700" id="contentBar">
            ...
            <div class="container mx-auto px-6 pt-4">
                <h3 class="text-gray-700 text-3xl font-medium dark:text-gray-50">Daftar Pengguna</h3>
            </div>
            <!-- End Titlepage -->
            ...
            <div class="container p-5">
                ...
                <div class="overflow-x-auto static shadow-md p-5 rounded-md">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-800" id="books">
                        <thead class="text-xs text-white uppercase bg-emerald-900 dark:bg-gray-800 dark:text-gray-200">
                            <tr>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="bg-white border-b dark:bg-gray-600 dark:border-gray-700 hover:bg-slate-200 dark:hover:bg-gray-400">
                                    ...
                                    <!-- <td class="py-4 px-6 text-gray-800 dark:text-slate-100 text-green-700 dark:text-green-500 font-medium"> -->
                                    <td class="py-4 px-6 text-sky-700 dark:text-sky-500 font-medium">
                                        <?= $row['status_passed']; ?>
                                    </td>
                                    <td class="py-4">
                                        <div class="flex flex-col sm:flex-row">
                                            <!-- <a href="#" class="font-medium py-1 px-3 bg-yellow-300 rounded-full shadow text-slate-600 hover:bg-yellow-600 hover:text-white hover:shadow-md text-center mb-1 sm:mb-0 sm:mr-1">Edit</a> -->
                                            <a href="./deleteUser.php?id=<?= $row["id_user"]; ?>" onclick="return confirm('Apakah yakin ingin menghapus pengguna?')" class="font-medium py-1 px-2 bg-red-500 rounded-full shadow text-slate-200 hover:bg-red-700 hover:text-white hover:shadow-md text-center">Hapus</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php

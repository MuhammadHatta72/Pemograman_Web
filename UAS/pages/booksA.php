    ...
    <div class="flex w-full bg-white dark:bg-slate-800">
        ...
        <div class="w-full h-screen bg-gray-50 rounded-l-xl overflow-y-scroll dark:bg-slate-700" id="contentBar">
            ...
            <div class="container p-5">
                <a href="./addBook.php" class="mb-4 bg-cyan-800 text-white px-6 py-2 rounded-md shadow-lg hover:bg-cyan-900 focus:outline-none focus:ring-2 focus:ring-cyan-600 focus:ring-opacity-50">Tambah Buku</a>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-600 dark:border-gray-700 hover:bg-cyan-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="py-4">
                                        <div class="flex flex-col sm:flex-row">
                                            <a href="./editBook.php?id=<?= $row["id_book"]; ?>" class="font-medium py-1 px-3 bg-yellow-300 rounded-full shadow text-slate-600 hover:bg-yellow-600 hover:text-white hover:shadow-md text-center mb-1 sm:mb-0 sm:mr-1">Edit</a>
                                            <a href="./deleteBook.php?id=<?= $row["id_book"]; ?>" onclick="return confirm('Apakah yakin ingin mengapus buku?')" class="font-medium py-1 px-2 bg-red-500 rounded-full shadow text-slate-200 hover:bg-red-700 hover:text-white hover:shadow-md text-center">Hapus</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php

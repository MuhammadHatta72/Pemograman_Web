    ...
    <div class="flex w-full bg-white dark:bg-slate-800">
        ...
        <div class="w-full h-screen bg-gray-50 rounded-l-xl overflow-y-scroll dark:bg-slate-700" id="contentBar">
            ...
            <div class="container mx-auto px-6 pt-4">
                <h3 class="text-gray-700 text-3xl font-medium dark:text-gray-50">Daftar Peminjaman</h3>
            </div>
            <!-- End Titlepage -->
            ...
            <div class="container p-5">
                ...
                <div class="overflow-x-auto static shadow-md p-5 rounded-md">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-800" id="books">
                        <thead class="text-xs text-white uppercase bg-gradient-to-r from-cyan-500 to-blue-500 dark:bg-gray-800 dark:text-gray-200">
                            <tr>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-600 dark:border-gray-700 hover:bg-slate-200 dark:hover:bg-gray-400">
                                    ...
                                    <td class="py-4 px-6">
                                        ...
                                        if ($row['status'] == "Dipinjam") {
                                            echo '<span class="text-green-700 dark:text-green-500 font-medium ">Dipinjam</span>';
                                        } else {
                                            echo '<span class="text-amber-500 dark:text-slate-100 font-medium">Dikembalikan</span>';
                                        }
                                        ?>
                                    </td>
                                    <td class="py-4">
                                        <div class="flex flex-col sm:flex-row">
                                            ...
                                            if ($row['status'] == "Dipinjam") {
                                                echo '
                                                <form method="POST" action="../controller/returnBookAction.php">
                                                <input type="hidden" name="transaction" value="' . $row['id_transaction'] . '">
                                                <input type="submit" name="submit" value="Kembalikan" class="font-medium py-1 px-3 bg-lime-500 rounded-full shadow text-slate-100 hover:bg-lime-800 hover:text-white hover:shadow-md text-center mb-1 sm:mb-0 sm:mr-1 cursor-pointer"></form>
                                                ';
                                            } else {
                                                echo '<a href="#" class="font-medium py-1 px-3 bg-cyan-500 rounded-full shadow text-slate-100 hover:bg-cyan-800 hover:text-white hover:shadow-md text-center mb-1 sm:mb-0 sm:mr-1">Detail</a>';
                                            }
                                            ?>
                                        </div>
                                    </td>

    ...
    <div class="flex w-full bg-white dark:bg-slate-800">
        ...
        <div class="w-full h-screen bg-gray-50 rounded-l-xl overflow-y-scroll dark:bg-slate-700" id="contentBar">
            ...
            <div class="container mx-auto px-6 pt-4">
                <h3 class="text-gray-700 text-xl sm:text-3xl font-medium dark:text-gray-50">Tambah Buku</h3>
            </div>
            <!-- End Titlepage -->
            ...
            <div class="container p-5">
                ...
                <div class="bg-white border border-gray-200 w-full rounded-lg shadow-md p-3 dark:bg-gray-800 dark:border-gray-700">
                    <form class="px-4" enctype="multipart/form-data" method="POST" action="../controller/addBookAction.php">
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <label for="book_title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Judul Buku</label>
                                <input type="text" id="book_title" name="book_title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Garis Waktu" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="book_type" name="book_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Novel" required>
                            </div>
                            <div class="sm:row-start-4 sm:col-start-1">
                                ...
                                <input type="number" id="year_public" name="year_public" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="2021" required>
                            </div>

                            <div>
                                <label for="bookcase_loc" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lokasi Rak Buku</label>
                                <input type="text" id="bookcase_loc" name="bookcase_loc" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="A-3" required>
                            </div>
                            <div>
                                <label for="stocks" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Total Buku</label>
                                <input type="number" id="stocks" name="stocks" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="30" required>
                            </div>
                            <div>
                                <label for="book_cover" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cover Buku</label>
                                <input type="file" id="book_cover" name="book_cover" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Garis Waktu" required>
                            </div>
                        </div>
                        <input type="submit" name="submit" value="Simpan" class="text-white bg-green-800 hover:bg-green-700 hover:shadow-md focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2 sm:px-10 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 cursor-pointer">
                    </form>

...
<head>
    ...
    <title>Laporan Transaksi - Sistem Informasi Perpustakaan</title>
    ...
    <div class="flex w-full bg-white dark:bg-slate-800">
        ...
        <div class="w-full h-screen bg-gray-50 rounded-l-xl overflow-y-scroll dark:bg-slate-700" id="contentBar">
            ...
            <div class="container mx-auto px-6 pt-4">
                <h3 class="text-gray-700 text-3xl font-medium dark:text-gray-50">Laporan Peminjaman & Pengembalian Buku</h3>
            </div>
            <!-- End Titlepage -->
            ...
            <div class="container p-5">
                ...
                <div class="overflow-x-auto static shadow-md p-5 rounded-md">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-800" id="books">
                        <thead class="text-xs text-white uppercase bg-orange-700 dark:bg-gray-800 dark:text-gray-200">
                            <tr>
                        ...
                        <tbody>
                            <?php
                            $i = 1;
                            $allTransaction = getAllTransaction();
                            while ($row = mysqli_fetch_assoc($allTransaction)) {
                            ?>
                                <tr class="bg-white border-b dark:bg-gray-600 dark:border-gray-700 hover:bg-cyan-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="py-4 px-6 text-gray-800 dark:text-slate-100">
                                        ...
                                        if ($row['status'] == 'Dikembalikan') {
                                            echo '<span class=" text-green-600 px-2 py-1 text-xs font-semibold">Dikembalikan</span>';
                                        } else {
                                            echo '<span class="text-yellow-500 px-2 py-1 text-xs font-semibold">Belum Dipinjam</span>';
                                        }
                                        ?>
                                    </td>
                                    <td class="py-4 px-6 text-gray-800 dark:text-slate-100">
                                        ...
                                        if ($row['condition_trans'] == 'Terlambat') {
                                            echo '<span class="text-yellow-500 px-2 py-1 text-xs font-semibold">Terlambat</span>';
                                        } else {
                                            echo '<span class="text-green-600 px-2 py-1 text-xs font-semibold">Tepat Waktu</span>';
                                        }
                                        ?>
                                    </td>
                                    <td class="py-4 px-6 dark:text-slate-100 text-sky-500">
                                        <?= $row['fine']; ?>
                                    </td>
                                </tr>
                            <?php
                    ...
                    <a href="./printReportTransaction.php" class="block font-semibold mt-3 py-1 px-4 sm:mt-5 sm:py-2 sm:px-6 bg-amber-600 rounded-full shadow text-slate-100 hover:bg-amber-800 hover:text-white hover:shadow-md text-center">Download Laporan</a>
                </div>

...
<head>
    ...
    <title>CRUD WEB-Tambah Siswa</title>
    <link rel="stylesheet" href="../assets/css/style.css">
</head>

<body>
    <h1 class="text-5xl text-center mt-5 mb-5 bg-gradient-to-r from-green-700 to-cyan-700 bg-clip-text text-transparent font-bold">TAMBAH SISWA-SISWI</h1>
    <hr>
        ...
        <div class="max-w-3xl mx-auto my-0 border border-slate-300 rounded-xl shadow-xl p-6">
            ...
            <form action="./tambahProses.php" method="POST">
                ...
                <label for="date_birth_student">
                    ...
                    <input type="date" id="date_birth_student" name="date_birth_student" placeholder="Masukkan Tanggal Lahir" class="px-3 py-2 border shadow rounded w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 invalid:text-pink-800 invalid:focus:ring-pink-800 invalid:focus:border-pink-800 peer" />
                    <p class="text-sm m-1 text-pink-800 invisible peer-invalid:visible">
                ...
                <label for="address_student">
                    ...
                    <input type="text" id="address_student" name="address_student" placeholder="Masukkan Alamat" class="px-3 py-2 border shadow rounded w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 invalid:text-pink-800 invalid:focus:ring-pink-800 invalid:focus:border-pink-800 peer" />
                    <p class="text-sm m-1 text-pink-800 invisible peer-invalid:visible">
                        Alamat invalid
                    </p>
                </label>
                <label for="gender_student">
                    ...
                    <div class="flex ">
                        <div class="form-check form-check-inline mr-2">
                            <input class="form-check-input form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="radio" name="gender_student" id="man" value="Laki-laki">
                            <label class="form-check-label inline-block text-gray-800" for="man">Laki-laki</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="radio" name="gender_student" id="woman" value="Perempuan">
                ...
                <label for="origin_school_student">
                    <span class="block font-semibold mb-1 text-slate-700 after:content-['*'] after:text-red-700 after:ml-2">Asal Sekolah</span>
                    <input type="text" id="origin_school_student" name="origin_school_student" placeholder="Masukkan Asal Sekolah" class="px-3 py-2 border shadow rounded w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 invalid:text-pink-800 invalid:focus:ring-pink-800 invalid:focus:border-pink-800 peer" />
                    <p class="text-sm m-1 text-pink-800 invisible peer-invalid:visible">
                        Asal Sekolah invalid
                    </p>
                </label>
                <input type="submit" name="Submit" class="w-full bg-sky-500 px-5 py-2 rounded-full text-white font-semibold block hover:bg-sky-700 active:bg-sky-900 focus:ring focus:ring-sky-400" value="Save Changes" />
            </form>
        </div>
    </section>
</body>
